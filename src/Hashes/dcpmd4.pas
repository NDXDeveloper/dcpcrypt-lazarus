{===============================================================================
  DCPcrypt v2.0.6 - A binary compatible implementation of MD4
...
{ MD4: 128-bit hash, 512-bit blocks, 3 rounds.
  Designed by Ron Rivest (1990). RFC 1320. Predecessor to MD5. }
type
