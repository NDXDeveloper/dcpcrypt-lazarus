{===============================================================================
  DCPcrypt v2.0.6 - A binary compatible implementation of RipeMD-160
...
{ RIPEMD-160: 160-bit hash, 512-bit blocks, 5 rounds with parallel computation.
  Designed by Dobbertin, Bosselaers, Preneel (1996). ISO/IEC 10118-3. }
type
